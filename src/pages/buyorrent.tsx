...
export default function BuyOrRent() {
	return (
		<Layout
			...
			results={[
				<ItemDisplay key="1" result="Option that costs lesser" svg={<SVGBalance />} />,
				<ItemDisplay key="2" result="Time till which the Option costs lesser" svg={<SVGHourGlass />} />,
				<ItemDisplay key="3" result={`Yearly Cash Flows for Buying`} svg={<SVGChart selected />} />,
				<ItemDisplay
					key="4"
