...
import AssetPrice from "../components/calc/AssetPrice";
...
import { IAContextProvider } from "../components/calc/IAContext";
...
export default function IA() {
  ...
  return (
		<Layout
		tabOptions={[
			{ label: ASSET, active: true, svg: faMoneyBillWave, content: <AssetPrice /> },
