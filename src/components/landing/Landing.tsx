...
export default function Landing() {
	...
	useEffect(() => {
		...
		const secCallback = (list: Array<any>) => list.forEach((entry: any) => setScrolledToSec(entry.isIntersecting));
	...
	return (
		<DDPage title="DollarDarwin">
			<div
				className={`fixed w-full h-12 left-0 z-10 md:h-16 ${top > 10 && 'shadow-lg'}`}
				style={{
					backgroundImage:
						top > 10
			...
			<div className="max-w-screen-xl m-auto">
				<Nav joinRef={joinRef} calculateRef={calculateRef} featuresRef={featuresRef} />
					...
					<div className="flex justify-items-auto">
						<div className="flex-1 pr-16">
							...
							<p className="mt-3">
								...
								minimums associated with traditional investment management. We invest your money in a
								globally diversified portfolio of low-cost index funds, and our cutting-edge technology
								helps you earn the best possible return, while optimizing your tax bill.
							</p>
						</div>
