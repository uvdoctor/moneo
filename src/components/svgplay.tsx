  ...
  return (
    ...
    >
      <g>
        ...
        <path d="m256 106h-226v300h226 226v-300z" fill={COLORS.RED} />
        <path d="m256 106h226v300h-226z" fill={COLORS.RED} />
        <g>
          <g fill="#404a80">
        ...
        <path
          ...
          fill="white"
        />
        <path d="m256 197.976v116.048l87.041-58.024z" fill="white" />
      </g>
    </svg>
  );
}
