...
interface SVGAAChartProps {
  disabled: boolean;
  selected: boolean;
}

export default function SVGAAChart({ disabled, selected }: SVGAAChartProps) {
  return (
    <svg enableBackground="new 0 0 64 64" viewBox="0 0 64 64" className="w-8">
      <g>
        <g>
          <g>
            <path
              d="m15.95 8.97c-1.36.95-2.63 2.01-3.8 3.18s-2.23 2.44-3.18 3.8c-.95 1.35-1.78 2.8-2.47 4.31-.7 1.51-1.27 3.09-1.68 4.73h-.01c-.41 1.62-.69 3.29-.81 5.01h6.03c.12-1.31.35-2.6.69-3.83.34-1.25.79-2.45 1.34-3.6.54-1.15 1.18-2.25 1.91-3.28s1.54-2 2.43-2.89 1.86-1.7 2.89-2.43z"
              fill={
                disabled
                  ? COLORS.DISABLED
                  : selected
          ...
          <g>
            <path
              d="m24.99 4.81v.01c-1.64.41-3.22.98-4.73 1.68-1.51.69-2.96 1.52-4.31 2.47l3.34 5c1.03-.73 2.13-1.37 3.28-1.91 1.15-.55 2.35-1 3.6-1.34 1.23-.34 2.52-.57 3.83-.69v-6.03c-1.72.12-3.39.4-5.01.81z"
              fill={COLORS.LIGHT_GRAY}
            />
          </g>
          <g>
            <path
              d="m48.04 8.96c6.76 4.72 11.35 12.33 11.96 21.04h-6.03c-.96-10.59-9.38-19.01-19.97-19.97v-6.03c5.2.37 10.01 2.15 14.04 4.96z"
              fill={
                disabled ? COLORS.DISABLED : selected ? "red" : COLORS.DEFAULT
              }
            />
          </g>
          <g>
            <path
              d="m53.97 34h6.03c-.98 13.91-12.09 25.02-26 26v-6.03c10.59-.96 19.01-9.38 19.97-19.97z"
              fill={
                disabled
                  ? COLORS.DISABLED
                  : selected
          ...
          <g>
            <path
              d="m15.96 55.04c-6.76-4.72-11.35-12.33-11.96-21.04h6.03c.96 10.59 9.38 19.01 19.97 19.97v6.03c-5.2-.37-10.01-2.15-14.04-4.96z"
              fill={
                disabled ? COLORS.DISABLED : selected ? "brown" : COLORS.DEFAULT
              }
            />
          </g>
          <g>
            <path d="m39 16-3 9h-8l-3-8 4-1 3 3 3-4z" fill={disabled ? COLORS.DISABLED : selected ? COLORS.GREEN : "white"} />
          </g>
          <g>
            <path
              d="m42.95 32.48c.69 1.5 1.05 3.14 1.05 4.83 0 6.45-5.24 11.69-11.69 11.69h-.62c-3.23 0-6.15-1.31-8.26-3.43-2.12-2.11-3.43-5.03-3.43-8.26 0-3.38 1.46-6.58 3.99-8.8l4.01-3.51h8l4.01 3.51c1.27 1.11 2.26 2.47 2.94 3.97z"
              fill={disabled ? COLORS.DISABLED : selected ? COLORS.GREEN : "white"}
            />
          </g>
          <g>
            <circle cx="4" cy="60" fill={COLORS.LIGHT_GRAY} r="2" />
          </g>
          <g>
            <circle cx="60" cy="4" fill={COLORS.LIGHT_GRAY} r="2" />
          </g>
        </g>
        <g>
