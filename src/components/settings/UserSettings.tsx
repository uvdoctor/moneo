...
export default function UserSettings(): JSX.Element {
	const { user, defaultCountry, validateCaptcha, owner, userInfo, discountRate, setDiscountRate }: any = useContext(
		AppContext
	);
		...
		>
			<TabPane className="settings-tabpane-view" tab="Personal" key="1">
				<Row>
					...
					<Col xs={24} sm={24} md={16}>
						<SaveButton loading={loading} error={error} onClick={updatePersonalTab} action="personal" />
					</Col>
				</Row>
			</TabPane>
			<TabPane className="settings-tabpane-view" tab="Profile" key="2">
				<Row>
					...
					<Col xs={24} sm={24} md={16}>
						<SaveButton loading={loading} error={error} onClick={updateProfileTab} action="profile" />
					</Col>
				</Row>
			</TabPane>
