...
const privacyContent = [
      ...
      content: (
        <Typography>
          <Paragraph>
            ...
            Moneo Private Limited operate mobile applications and website
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <Text strong>Investments information:</Text>
          <Text>
          ...
          <Paragraph>
            ...
            These are investment statements that you get from depositories or
            brokers or Registrar & Transfer Agents such as Computer Age
            Management Services, Karvy Fintech Private Limited, National
            Securities Depositories Limited, Central Depositories Services
            Limited, etc. You provide explicit consent to Moneo to fetch these
            statements from
          ...
          <Paragraph>
            ...
            your 12-digit Universal Account Number, assigned to you as a member
            of EPFO, and the related password. Your EPFO password will be stored
            by Moneo at a local device in encrypted format and will be stored on
            our server in encrypted format. We use AWS Key Management Service
            Feature for storing your EPFO password. This will enable Moneo to
            consolidate and present your comprehensive EPF passbook data. This
            will also help you to get an accurate picture of your overall
          ...
          <Paragraph>
            ...
            I statement. Your NPS-Tier I statement password will be stored by
            Moneo at a local device in encrypted format and will be stored on
            our server in encrypted format. We use AWS Key Management Service
            Feature for storing your NPS-Tier I statement password. This will
            enable Moneo to consolidate and present your comprehensive NPS-Tier
            I data as well as provide tax saving advisory which includes NPS.
            This will also help you to get an accurate picture of your overall
            investment details on your Moneo dashboard. You can choose to
            de-track NPS-Tier I Investments anytime from the NPS-Tier I
          ...
          <Paragraph>
            ...
            communications with Us. However, in the event You wish to provide Us
            with Your Aadhar card information, You hereby agree and acknowledge
          ...
          <Paragraph>
            ...
            The LSO token expires when a user logs out of our website or mobile
            application. We do not collect any information about your online
            activity when you sign-out and/or leave our services. We use third
            party analytics services in order to better understand user
            engagement with the Services. When a user browses or uses the
            Services, these third party analytics services may collect the
            user’s IP address, browser type, and approximate location (based on
            the IP address). They may also use web logs or web beacons and may
            set and access cookies on your computer or other device. These third
            party analytics services may deploy cookies on your browser. Your
            ...
            activities over time and across different websites. Do Not Track
            signals are set on a browser-by-browser basis, so you must set them
            on every browser you use if you do not wish to be tracked. We do not
            share and will never share any confidential data such as user’s
            investment details, bank details, transaction details, income or any
            other sensitive details with these third party analytics service
            providers.
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            ...
            by you from providers of services and/or banks (including but not
            limited to retail outlets, financial institutions, and utility
            companies) on your Android mobile device. This will enable us to
            organise your expenses and saving account balances across your
            transactions and banks in one view and also provide analytics on the
            same to you. This will also help you to get an accurate picture of
            your overall wealth and networth on your Moneo dashboard. No
            personal SMSes or OTPs are accessed by Moneo. You can choose to
            opt-out of the expense and saving account balance analytics services
            at any time by writing to https://moneo.in/contact-us Alternatively,
            you can also opt-out of the expense and saving account balance
          ...
          <Paragraph>
            ...
            <li>
              1. Moneo limits use of data to providing or improving your user
              experience. Giving consent to access your SMS text messages (on
              your Android phone) to Moneo Android App is completely optional
              and based on your explicit consent for only specific use cases of
              organising your expenses and saving account balances and as
              described in this Privacy Policy. The benefit of giving explicit
              consent for this option is that Moneo Android application is
              enabled to organise all your fragmented expenses across your
              transactions and saving accounts across your banks on the Moneo
              App dashboard. Moneo Android application is also enabled to give
              you analytics across your expenses and saving account balances.
            ...
            <li>
              2. We do not use or transfer the data for serving ads, including
            ...
            <li>
              (b) It is necessary for security purposes (such as investigating a
              bug or abuse);
            </li>
            <li>(c) It is necessary to comply with applicable law; or </li>
            <li>
              (d) Our use is limited to internal operations and the data
              (including derivations) have been aggregated and anonymized.
            </li>
            These prohibitions of use of data apply to the raw data obtained
            from your SMS and data aggregated, anonymized, or derived from them.
            Our employees, agents, contractors, and successors comply with these
            policies
          </Paragraph>
        </>
      ),
      ...
      content: (
        <>
          <Paragraph>
            ...
            customize Google Display Network ads using the Ads Settings options
            provided by Google.
          </Paragraph>
          <Paragraph>
            ...
            circumstances mentioned in Information Sharing section.
            <Paragraph>
          ...
          <Paragraph>
            ...
            <li>
              • provide a smooth, safe and customized experience to the User on
              Moneo Platform;
            </li>
            <li>
              • provide/promoting its products and services on the Moneo
              Platform- general as well as customized and improve the same from
              time to time;
            </li>
            <li>
              • provide You the most user-friendly experience and for developing
              new services;
            </li>
            <li>
              • analyse flow, track user trends, measure promotional
              effectiveness;
            </li>
            <li>
              • provide additional features on the Moneo Platform through
              Cookies;
            </li>
            <li>
              • protect the safety and integrity of the Moneo Platform,
              information and maintain the confidentiality of the User and their
              data;
            </li>
            <li>• Ensure smooth execution of transaction and payments;</li>
            <li>
              • Maintain, improve and provide Service (including personalization
              of Moneo Platform);
            </li>
            <li>
              • Inform the User about new/change in
              products/services/offers/updates/reminders, billing information,
              customer service(s) etc.;
            </li>
            <li>
              • To detect and/or prevent any fraudulent/criminal/prohibited
              activity on Moneo Platform;
            </li>
            <li>
              • To process Your request or respond to Your
              queries/grievances/comments;
            </li>
            <li>• Send customized messages/notifications to You;</li>
            <li>
              • Communicate any change in Our services/products/Terms and
              Conditions/Privacy policy;
            </li>
            <li>
              • Marketing and commercial communications regarding
              services/products;
            </li>
            ...
            <li>
              • Updated regarding third party services and products and products
              and services offered on other Sites;
            </li>
            <li>• Data analysis/analytics;</li>
            <li>• Pre-filling of various forms;</li>
            <li>• Maintain User Account;</li>
            <li>• Provide general information/updates</li>
    ...
    },
    {
      ...
      content: (
        <Typography>
          The Company may share Your Information with authorised third party
          without obtaining the prior consent of the User in the following
          circumstances but not limited to:
          <li>• In order to provide seamless experience</li>
          <li>
            • To provide various services/products to the User of the Company as
            well as of the third parties
          </li>
          <li>
            • Customize offers/products/services based on the User needs or
            behavioural pattern
          </li>
          <li>• Ensure smooth execution of transaction and payments</li>
          ...
          <Paragraph>
            <li>
              ...
              investigation including but not limited to cyber incidents, or for
            ...
            <li>
              3. The Company may present Information with third parties - to
              ...
              identifiable information) about Your visits to this and other
              websites or application, in order to provide advertisements about
              goods and services of interest to You. We also share User Personal
              Information with Our vendors/service providers -- to help Us
              understand about Our User Behaviour and/or to serve ads when You
              visit Moneo platform. These companies may use Information
              (excluding Your name, address, email address or telephone number
              or other personally identifiable information) about Your visits to
              this and other websites or application. We use third-party
              advertising companies to serve ads when You visit or use Our Sites
              or Services. These companies may use information (excluding Your
              name, address, email address or telephone number or any personally
              identifiable information) about Your visits or use to particular
              website, mobile application or services, in order to provide
              advertisements about goods and services of interest to You.
            </li>
            <li>
              4. The Company may share Your Information regarding Your
              activities on Sites with third party social websites to populate
              Your social wall that is visible to other people however You will
              have an option to set Your privacy settings, where You can decide
              what You would like to share or not to share with others.
            </li>
            <li>
              5. We may share Your Information to enforce or protect Our rights
            ...
            <li>
              6. We may share information with consultants/third
              parties/business partners/vendors for providing Our and/or their
              various products/ services. The handling of Your Information by
              such Consultants/third parties/business partners/vendors shall be
              as per the privacy policies of those consultants/ third parties/
              business partners/ vendors. The Company shall not be responsible
              or liable for any action or omission of these consultants/ third
              parties/ business partners/ vendors with respect to Your
              Information.
            </li>
          </Paragraph>
        </Typography>
    ...
    {
      title: "Does Moneo Share Personal Information?",
      content: (
        <Typography>
          ...
          <Paragraph>
            ...
            <Paragraph>
              ...
              <li>
                (b) It is necessary for security purposes (such as investigating
                a bug or abuse);
              </li>
              <li>(c) It is necessary to comply with applicable law; or</li>
              <li>
            ...
            These prohibitions of user of data apply to all the information/
            data obtained from you with your explicit consent .Our employees,
            agents, contractors, and successors comply with this Policy.
          </Paragraph>
        </Typography>
      ),
    },
      ...
      content: (
        <Typography>
          <Paragraph>
            ...
            or amended as feasible, subject to any requirement for such personal
            ...
            or for which access is not otherwise required. In any case, where We
            provide information access and correction, We perform this service
            free of charge, except if doing so would require a disproportionate
          ...
          <Paragraph>
            ...
            information that We maintain about You, and You may request that We
            delete personal information about You that is inaccurate, incomplete
            or irrelevant for legitimate purposes, or are being processed in a
            way which infringes any applicable legal requirement.
          </Paragraph>
          <Paragraph>
            Your right to review, update, correct etc. Your information is
          ...
          <Paragraph>
            ...
            for a longer period. We shall store the data in our database even if
            the User has chosen not to be contacted and/ or closed his/her
            account with the Company. We shall store the
            data/information/records on a server owned by Us or its group
            companies in India. We may keep Our records of the electronic
            instructions/transactions in any form as permitted under applicable
            Laws. In this regard, all records, whether in electronic form,
            magnetic form, documents or any other form with respect to
            electronic instructions/online transactions shall be conclusive
            evidence of such instructions/transactions and shall be binding on
            the User
          </Paragraph>
        </Typography>
      ),
    },
    {
      ...
      content: (
        <Paragraph>
          ...
          information gathered on Moneo is securely stored within the Company
    ...
    },
    {
      ...
      content: (
        <Paragraph>
          ...
          time to time to incorporate necessary changes in technology,
          applicable law or any other variant. In any case, We reserve the right
          to change (at any point of time) the terms of this Policy or the Terms
          of Use. Any changes We make will be effective immediately on notice,
          which We may give by posting the new policy on the Sites. Your use of
          the Sites or Services after such notice will be deemed acceptance of
          such changes. We may also make reasonable efforts to inform You via
    ...
    },
    {
      ...
      content: (
        <Paragraph>
          Moneo reserves the right to change this policy from time to time. Any
          changes shall be effective immediately upon the posting of the revised
          Privacy Policy. While we will make reasonable efforts to keep you
          posted on any updates to this privacy policy, to make sure that you
          are aware of any changes, we recommend that you review this policy
          periodically. If you are not comfortable with any of the changes to
          Privacy Policy you may choose to discontinue usage of Moneo website or
          mobile applications. You can also email us at xxx@xxx.co to update or
          delete your personal information that Moneo has collected.
        </Paragraph>
      ),
    },
    {
      ...
      content: (
        <Typography>
          <Paragraph>
            ...
            Privacy Policy, please contact us immediately at
            support@stackfinance.co or xxx@xxx.co In certain cases, you may have
            the ability to view or edit your personal information online. In the
            event your information is not accessible online and you wish to
            change or delete your personal information or other information that
            you may have provided, please contact us immediately at xxxx@xxxx.co
          </Paragraph>
          <Paragraph>
            The Prevention of Money Laundering Act 2002 and SEBI (Investment
            Advisors) Regulations, 2013 require record retention for a period of
            up to 5 years post the deletion of your account. In the event of the
            pendency of any legal/ regulatory proceeding or receipt of any legal
            and/or regulatory direction to that effect, we may retain your
      ...
      content: (
        <Typography>
          <Paragraph>
            ...
            systems ranging from low hanging issues up to sophisticated attacks.
            You can read more about it here
          </Paragraph>
          <Paragraph>
            If you are a security enthusiast or a researcher and you have found
            a possible security vulnerability on Moneo, we encourage you to
            report the issue to us responsibly.
          </Paragraph>
          <Paragraph>
            You could submit a bug report to us at xxxx@xxxx.co with detailed
          ...
          <Paragraph>
            ...
            more robust and safe for all users, you can share those with us at
            xxxx@xxxx.in
          </Paragraph>
        </Typography>
      ),
