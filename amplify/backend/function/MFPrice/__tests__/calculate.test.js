...
describe("Test Direct ISIN", () => {
  test("With Data", () => {
    const data = directISIN([
      {
        "Scheme Name": "UTI - NIFTY Index Fund-Growth Option- Direct",
        "Scheme Type": "Open Ended Schemes(Other Scheme - Index Funds)",
        "ISIN Div Payout/ISIN Growth": "INF3764032904",
        "ISIN Div Reinvestment": "INF9394594395",
      },
      {
        "Scheme Name": "UTI - NIFTY Index Fund-Growth Option- Regular",
        "Scheme Type": "Open Ended Schemes(Other Scheme - Index Funds)",
        "ISIN Div Payout/ISIN Growth": "INF3764032904",
        "ISIN Div Reinvestment": "INF9394594395",
      },
    ...
    expect(data).toEqual({
      regularData: ["uti-niftyindexfund-growthoption-regular"],
      directData: [
        {
          ISIN: "INF3764032904",
          name: "uti-niftyindexfund-growthoption-regular",
        },
      ],
    });
  });
...
describe("Test get direct ISIN", () => {
  test("With Data", () => {
    const data = getDirISIN(
      ["uti-niftyindexfund-growthoption-regular"],
      [
        {
          ISIN: "INF3764032904",
          name: "uti-niftyindexfund-growthoption-regular",
    ...
    expect(data).toEqual("INF3764032904");
  });
...
describe("Mcap", () => {
  ...
  test("With Data", () => {
    ...
    expect(data).toEqual("Hybrid");
  });

  test("With Data", () => {
    const data = mcap({
      "Scheme Name": "HDFC Hybrid Debt Fund - IDCW Quarterly Mid",
      "Scheme Type":
        "Open Ended Schemes(Hybrid Scheme - Conservative Hybrid Fund)",
    });
    expect(data).toEqual("Mid");
  });

  test("With Data", () => {
    const data = mcap({
      "Scheme Name": "HDFC Hybrid Debt Fund - IDCW Quarterly Small",
      "Scheme Type":
        "Open Ended Schemes(Hybrid Scheme - Conservative Hybrid Fund)",
    });
